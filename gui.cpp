...
--------------------------------------------------------*/
#define PULSE_INPUT_PIN 9  // Rotaty Encoder A
#define PULSE_CTRL_PIN  10  // Rotaty Encoder B
...
const int	tca_sda = 47;
const int	tca_sdi = 48;
const int	tca_pcf = 2;
const int	PCF8754_INT = 13; //35 or 4 (vfo pcb)
